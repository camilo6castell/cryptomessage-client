...
import { themeConfig } from '../../styles/config/ThemeConfig';
...
const Wave = styled.div`
  ...
  &.a {
    animation: ${waves.floatA} ${themeConfig.animation.waves_duration.a}s
    ...
    background:
      radial-gradient(circle at 20% 20%, var(--wave-color-a), transparent 25%),
      radial-gradient(circle at 80% 80%, var(--wave-color-b), transparent 25%);
    filter: blur(var(--wave-blur-a));
    opacity: var(--wave-opacity-a);
  }
  &.b {
    animation: ${waves.floatB} ${themeConfig.animation.waves_duration.b}s
      ease-in-out infinite;
    top: var(--wave-top-b);
